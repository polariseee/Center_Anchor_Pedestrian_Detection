...
class GenCaltech(object):
    def __init__(self):
        self.root_dir = '/home/zhangl/DATASET/Caltech/Final_Caltech/train'
        ...
        self.res_path_gt = '/home/zhangl/DetectionCode/CAP/data/cache/caltech/train_gt'
        self.res_path_nogt = '/home/zhangl/DetectionCode/CAP/data/cache/caltech/train_nogt'
        self.rows = 480
        self.cols = 640
        self.image_data_gt = []
